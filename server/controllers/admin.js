...
const getDashboardStats = TryCatch(async (req, res) => {
  ...
  const dayInMillsecons = 1000 * 60 * 60 * 24;

  last7DaysMessages.forEach((messages) => {
    const indexApprox =
      (today.getTime() - messages.createdAt.getTime()) / dayInMillsecons;
...
export { adminLogin, adminLogout, allChats, allMessages, allUser, getAdminData, getDashboardStats };
